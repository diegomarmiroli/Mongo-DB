    ...
    await testMethodPUT(
        ...
        [
            ...
            (data) => ({
                ...
                result: data && data.payload && data.payload.codigo == 16 && data.payload.nombre === "Modular metálico deluxe" && data.payload.precio == 999.75 && data.payload.categoria === "Oficina",
            }),
            (data) => ({
                subTitle: `No debe existir la propiedad color en el registro con código 16`,
                result: data && data.payload && data.payload.color === undefined,
    ...
    await testMethodGET(
        ...
        [
            (data) => ({
                ...
                result: data && data.payload && data.payload.codigo == 6 && data.payload.nombre === "Silla de comedor metálica" && data.payload.precio == 79.99 && data.payload.categoria === "Comedor",
            }),
        ]
    );
    ...
    await testMethodGET(
        ...
        [
            (data) => ({
                ...
                result: data && data.message && data.message === `El código no corresponde a un mueble registrado`,
            }),
        ]
    );
